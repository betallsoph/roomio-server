...
roomio-api/src/lib/server/rental-types.test.ts:15: assert.equal(canonicalRentalType('serviced\*apartment'), 'MOTEL');
...
roomio-api/src/lib/server/rental-types.ts:26:/\*\* Split comma list, canonicalize, dedupe, filter valid; default ['APARTMENT'] when empty. \_/
