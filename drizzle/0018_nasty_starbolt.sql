...
CREATE INDEX "Room_paymentAccountId_idx" ON "Room" USING btree ("paymentAccountId");--> statement-breakpoint
...
ALTER TABLE "TelegramBotSession" ADD CONSTRAINT "TelegramBotSession_tenantId_TenantProfile_id_fk" FOREIGN KEY ("tenantId") REFERENCES "public"."TenantProfile"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "TelegramBotSession_tenantId_idx" ON "TelegramBotSession" USING btree ("tenantId");--> statement-breakpoint
